...
import com.green.repo.UserRepository;
...
public class UserController 
{
	...
	/*
	 * @GetMapping(value = "/logout") public String logout_user(HttpSession session)
	 * { session.removeAttribute("username"); session.invalidate(); return
	 * "redirect:/login"; }
	 */
